...
namespace Entities.Migrations
{
    ...
    [Migration("20210418100308_AddZaloPayment")]
    partial class AddZaloPayment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.ZalopayOrder", b =>
                {
            ...
            modelBuilder.Entity("Entities.Models.ZalopayRefund", b =>
                {
                    b.Property<string>("Mrefundid")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("Mrefundid");

                    b.HasIndex("OrderId")
                        .IsUnique();

                    b.ToTable("ZalopayRefunds");
                });
            ...
            modelBuilder.Entity("Entities.Models.ZalopayOrder", b =>
                {
                    b.HasOne("Entities.Models.Order", "Order")
                        .WithOne("ZalopayOrder")
                        .HasForeignKey("Entities.Models.ZalopayOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entities.Models.ZalopayRefund", b =>
                {
                    b.HasOne("Entities.Models.Order", "Order")
                        .WithOne("ZalopayRefund")
                        .HasForeignKey("Entities.Models.ZalopayRefund", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entities.Models.Order", b =>
                {
                    ...
                    b.Navigation("ZalopayOrder");

                    b.Navigation("ZalopayRefund");
                });
